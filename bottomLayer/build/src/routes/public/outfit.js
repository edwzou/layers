...
router.get('/:outfitId', function (req, res) {
    var outfitId = req.params.outfitId;
    var getOutfitById = function (outfitId) { return __awaiter(void 0, void 0, void 0, function () {
        var outfit, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, sqlImport_1.pool.query('SELECT * FROM backend_schema.outfit WHERE oid = $1', [outfitId])];
                case 1:
                    outfit = _a.sent();
                    result = outfit.rows;
...
router.get('/u/:userId', function (req, res) {
    ...
    var client = sqlImport_1.pool.connect();
    // Query outfits for the specified user
    var getAllOutfits = function (userId) { return __awaiter(void 0, void 0, void 0, function () {
        var run, _a, _b, result, outfits, error_2;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 4, 5, 7]);
                    run = sqlImport_1.pool.query('SELECT * FROM backend_schema.outfit WHERE uid = $1', [userId]);
                    _a = responseCallback_1.getUserCore;
                    _b = [userId];
                ...
                case 4:
                    error_2 = _c.sent();
                    (0, responseCallback_1.responseCallbackGet)(error_2, null, res);
                    return [3 /*break*/, 7];
