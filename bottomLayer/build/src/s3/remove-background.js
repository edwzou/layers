...
function removeBackground(imageData) {
    return __awaiter(this, void 0, void 0, function () {
        var formData, config, response, imageURL, downloadedImageResponse, downloadedImageBuffer, error_1;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    config = {
                        ...
                        headers: __assign({ 'Rm-Token': process.env.RB_API_KEY }, formData.getHeaders()),
                        data: formData
                    };
                ...
                case 2:
                    downloadedImageResponse = _a.sent();
                    downloadedImageBuffer = Buffer.from(downloadedImageResponse.data);
                    return [2 /*return*/, downloadedImageBuffer];
                case 3: throw new Error('Error removing background - invalid API response');
                case 4: return [3 /*break*/, 6];
                case 5:
                    error_1 = _a.sent();
                    console.log('Error removing background:', error_1);
                    throw error_1;
