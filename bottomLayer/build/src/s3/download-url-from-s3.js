    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, s3_request_presigner_1.getSignedUrl)(awsImport_1.s3, new client_s3_1.GetObjectCommand(params), {
                            expiresIn: 3600
                        })];
                case 2:
                    signedUrl = _a.sent();
                    urlParts = new URL(signedUrl);
                    shorterUrl = "".concat(urlParts.origin).concat(urlParts.pathname);
                    // Return the shorter URL if it fits within 255 characters
                    if (shorterUrl.length <= 255) {
                        return [2 /*return*/, shorterUrl];
                    }
